...
- [ ] 54-02-PLAN.md — pending_scan cookie route + dialog callbackURL same-origin fix (FUNNEL-02)
- [ ] 54-03-PLAN.md — persistSuggestion helper + PendingScanRunner + layout mount (FUNNEL-03/04)
...
| 54. Auth Round-Trip + Persistence | 1/4 | In Progress|  |
