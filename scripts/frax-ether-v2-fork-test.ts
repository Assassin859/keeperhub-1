 ...
 *
 *   Use `stable`, not `latest` - on GHCR `latest` is foundry's nightly
 *   tag, whose contents change daily and have shipped anvil builds that
 *   cannot fork some chains at all.
 *
