...
variable "NEXT_PUBLIC_ONBOARDING_WF_AAVE_HEALTH" { default = "" }
variable "NEXT_PUBLIC_ONBOARDING_WF_LARGE_WITHDRAWAL" { default = "" }
variable "NEXT_PUBLIC_ONBOARDING_WF_GOVERNANCE" { default = "" }
variable "NEXT_PUBLIC_ONBOARDING_WF_SKY_STAKING" { default = "" }
variable "NEXT_PUBLIC_ONBOARDING_WF_STETH_WRAP" { default = "" }
variable "NEXT_PUBLIC_ONBOARDING_WF_USDS_SAVINGS" { default = "" }
...
target "app" {
  ...
  args = {
    ...
    NEXT_PUBLIC_ONBOARDING_WF_AAVE_HEALTH = NEXT_PUBLIC_ONBOARDING_WF_AAVE_HEALTH
    NEXT_PUBLIC_ONBOARDING_WF_LARGE_WITHDRAWAL = NEXT_PUBLIC_ONBOARDING_WF_LARGE_WITHDRAWAL
    NEXT_PUBLIC_ONBOARDING_WF_GOVERNANCE = NEXT_PUBLIC_ONBOARDING_WF_GOVERNANCE
    NEXT_PUBLIC_ONBOARDING_WF_SKY_STAKING = NEXT_PUBLIC_ONBOARDING_WF_SKY_STAKING
    NEXT_PUBLIC_ONBOARDING_WF_STETH_WRAP = NEXT_PUBLIC_ONBOARDING_WF_STETH_WRAP
    NEXT_PUBLIC_ONBOARDING_WF_USDS_SAVINGS = NEXT_PUBLIC_ONBOARDING_WF_USDS_SAVINGS
