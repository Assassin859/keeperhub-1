...
# Onboarding starter workflows: public HUB workflow ids the "Get started"
# launcher clones into a new user's org. Baked into the client bundle.
ARG NEXT_PUBLIC_ONBOARDING_WF_AAVE_HEALTH
ARG NEXT_PUBLIC_ONBOARDING_WF_LARGE_WITHDRAWAL
ARG NEXT_PUBLIC_ONBOARDING_WF_GOVERNANCE
ARG NEXT_PUBLIC_ONBOARDING_WF_SKY_STAKING
ARG NEXT_PUBLIC_ONBOARDING_WF_STETH_WRAP
ARG NEXT_PUBLIC_ONBOARDING_WF_USDS_SAVINGS
ENV NEXT_PUBLIC_ONBOARDING_WF_AAVE_HEALTH=$NEXT_PUBLIC_ONBOARDING_WF_AAVE_HEALTH
ENV NEXT_PUBLIC_ONBOARDING_WF_LARGE_WITHDRAWAL=$NEXT_PUBLIC_ONBOARDING_WF_LARGE_WITHDRAWAL
ENV NEXT_PUBLIC_ONBOARDING_WF_GOVERNANCE=$NEXT_PUBLIC_ONBOARDING_WF_GOVERNANCE
ENV NEXT_PUBLIC_ONBOARDING_WF_SKY_STAKING=$NEXT_PUBLIC_ONBOARDING_WF_SKY_STAKING
ENV NEXT_PUBLIC_ONBOARDING_WF_STETH_WRAP=$NEXT_PUBLIC_ONBOARDING_WF_STETH_WRAP
ENV NEXT_PUBLIC_ONBOARDING_WF_USDS_SAVINGS=$NEXT_PUBLIC_ONBOARDING_WF_USDS_SAVINGS
