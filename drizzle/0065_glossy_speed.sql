...
CREATE UNIQUE INDEX "safe_role_allowances_role_protocol_token_unique" ON "safe_role_allowances" USING btree ("role_id","protocol_slug","token_address");--> statement-breakpoint
