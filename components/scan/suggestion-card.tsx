...
export function SuggestionCard({
  ...
  return (
    ...
    <article
      ...
      className="group relative flex min-h-[160px] cursor-pointer flex-col rounded-xl border border-border/20 bg-[var(--color-hub-card)] p-4 shadow-sm transition-all duration-150 before:absolute before:inset-0 before:z-[1] before:cursor-pointer before:rounded-xl before:content-[''] hover:-translate-y-0.5 hover:border-[var(--color-border-accent)] hover:shadow-[0_6px_20px_-6px_var(--color-bg-accent)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-border-accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-hub-overlay)] motion-reduce:transition-none motion-reduce:hover:translate-y-0"
      onClick={handleClick}
