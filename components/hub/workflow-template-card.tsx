...
export function WorkflowTemplateCard({
  ...
  return (
    ...
    <article
      ...
      className={`group relative flex cursor-pointer flex-col overflow-hidden rounded-xl border border-border/20 bg-[var(--color-hub-card)] shadow-sm transition-colors duration-150 before:absolute before:inset-0 before:z-[1] before:cursor-pointer before:content-[''] hover:brightness-125 motion-reduce:transition-none ${className ?? "aspect-square"}`}
